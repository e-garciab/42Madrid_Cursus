...
/*   Updated: 2025/07/16 14:10:37 by egarcia2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minitalk.h"

// DUDA:Tendría que salir cuando ya haya terminado de recibir la señal?? siempre se queda en espera.

static void	set_client_pid(siginfo_t *info, pid_t *client_pid, int *bit_count, unsigned char *c, int *index, char *buffer)
{
...
static void	print_string(char **buffer, int *index)
{
